defmodule ReIntegrations.TestCloudex do
  ...
  def upload(["/garage.jpg", "/room.jpg"]) do
    [
      ok: %Cloudex.UploadedImage{
        ...
        resource_type: "image",
        secure_url: "https://res.cloudinary.com/qxo1cimsxmb2vnu5kcxw.jpg",
        signature: "xxx",
        source: "/room.jpg",
        tags: [],
        type: "upload",
        url: "http://res.cloudinary.com/qxo1cimsxmb2vnu5kcxw.jpg",
        version: 1_559_642_962,
        width: 2025
      },
      error: "File /room.jpg does not exist."
    ]
  end
