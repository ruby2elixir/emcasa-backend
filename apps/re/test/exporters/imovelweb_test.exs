defmodule Re.Exporters.ImovelwebTest do
  ...
  describe "build_node/2" do
    test "export XML with images from listing" do
      ...
      expected_xml =
        "<Imovel>" <>
          ...
          "<PrecoCondominio>10</PrecoCondominio>" <>
          "<PrecoIptuImovel>20</PrecoIptuImovel>" <>
    ...
    test "mark highlight listing" do
      listing = %Listing{
        id: 7_004_578,
        price: 800,
        type: "Apartamento",
      ...
      generated_xml =
        listing
        |> Imovelweb.build_node(Imovelweb.merge_default_options(%{highlight_ids: [7_004_578]}))
        |> XmlBuilder.generate(format: :none)

      assert expected_xml == generated_xml
    end

    test "mark super highlight listing" do
      listing = %Listing{
        id: 7_004_578,
        price: 800,
        type: "Apartamento",
      ...
      generated_xml =
        listing
        |> Imovelweb.build_node(
          Imovelweb.merge_default_options(%{super_highlight_ids: [7_004_578]})
        )
        |> XmlBuilder.generate(format: :none)
    ...
    test "export XML with nil description" do
      listing = %Listing{
        id: 7_004_578,
        price: 800,
        maintenance_fee: 10,
