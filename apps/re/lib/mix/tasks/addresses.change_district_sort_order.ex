defmodule Mix.Tasks.Re.Addresses.ChangeDistrictSortOrder do
  ...
  @districts_sort_order [
    ...
    %{name_slug: "moema", sort_order: 13},
    %{name_slug: "aclimacao", sort_order: 14},
    %{name_slug: "bosque-da-saude", sort_order: 15},
    %{name_slug: "vila-olimpia", sort_order: 16},
    %{name_slug: "brooklin", sort_order: 17},
    %{name_slug: "chacara-klabin", sort_order: 18},
